function initializeSchema(db) {
  db.exec(`
    ...
    -- V2 Extended Tables: Member Affinity, Guild Lore, Custom Personalities, Hot Take Votes
    CREATE TABLE IF NOT EXISTS user_affinity (
      guild_id TEXT NOT NULL,
      user_id TEXT NOT NULL,
      affinity_score INTEGER NOT NULL DEFAULT 0,
      total_interactions INTEGER NOT NULL DEFAULT 0,
      sentiment_tag TEXT NOT NULL DEFAULT 'neutral',
    ...
    CREATE TABLE IF NOT EXISTS custom_personalities (
      ...
      style TEXT NOT NULL,
      created_at INTEGER NOT NULL,
      PRIMARY KEY (guild_id, personality_id)
    );
    ...
    CREATE INDEX IF NOT EXISTS idx_guild_lore_guild
      ON guild_lore (guild_id, category, usage_count);

    CREATE INDEX IF NOT EXISTS idx_user_affinity_guild
      ON user_affinity (guild_id, user_id, affinity_score);
  `);
}
