...
const templates = {
  roast: [
    ...
    ['aura_loss', 'catastrophic aura loss detected'],
    ['main_character_fail', 'bro thinks he is the main character']
  ],
  target_spoke: [
    ['finally', 'finally'],
    ...
    ['who_let_him_cook', 'who let him in the kitchen']
  ],
  mention: [
    ...
    ['unlocked_trouble', 'you unlocked trouble']
  ],
  defender: [
    ...
    ['dont_defend_npc', "don't defend the NPC"]
  ],
  fake_accusation: [
    ...
    ['glitch_in_matrix', 'bro just glitched out of bounds']
  ],
  achievement: [
    ...
    ['zero_context', '🏆 Achievement Unlocked\n\nZero Context Banter']
  ],
  argument: [
    ['cope', 'cope'],
    ['nah', 'nah'],
  ...
  secrecy: [
    ...
    ['prophecy', 'the ancient prophecy demanded it']
  ]
};
